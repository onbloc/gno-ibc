...
help:
	...
	@echo "  test-eth-to-gno-bad-proof-smoke — assert Gno rejects a wrong ETH packet commitment proof"
	@echo "  test-sepolia-ugnot-fixtures — validate offline Sepolia Union ugnot fixtures"
	@echo "  test-zkgm-tokenorder-vectors — validate offline Gno -> Union TokenOrder payload vectors"
...
test-eth-to-gno-bad-proof-smoke: verify-gno vendor
	@./tools/eth-gno-smoke/smoke.sh eth-to-gno-bad-proof
