...
| [`gen-ethereum-embedded-node-proof-fixture/`](gen-ethereum-embedded-node-proof-fixture/) | Go harness that emits a go-ethereum MPT proof containing embedded (inline) child nodes for the Gno MPT verifier's embedded-node tests |
