...
func loadConfig() config {
	return config{
		...
		GnoPacketConnectionID:   os.Getenv("GNO_PACKET_CONNECTION_ID"),
		GnoPacketChannelID:      os.Getenv("GNO_PACKET_CHANNEL_ID"),
		...
		UnionPacketChannelID:    os.Getenv("UNION_PACKET_CHANNEL_ID"),
		UnionPacketConnectionID: os.Getenv("UNION_PACKET_CONNECTION_ID"),
		...
		UnionGnoClientID:        os.Getenv("UNION_GNO_CLIENT_ID"),
		...
		UnionEVMConnectionID:    os.Getenv("UNION_EVM_CONNECTION_ID"),
		UnionEVMChannelID:       os.Getenv("UNION_EVM_CHANNEL_ID"),
		EVMRPC:                  getenv("EVM_RPC", "http://localhost:8545"),
		EVMChainID:              getenv("EVM_CHAIN_ID", "32382"),
		EVMUnionClientID:        os.Getenv("EVM_UNION_CLIENT_ID"),
		EVMUnionConnectionID:    os.Getenv("EVM_UNION_CONNECTION_ID"),
		EVMUnionChannelID:       os.Getenv("EVM_UNION_CHANNEL_ID"),
