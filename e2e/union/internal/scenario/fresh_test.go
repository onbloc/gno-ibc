...
func TestFreshScenarioCallsSixClientsInDocumentedOrder(t *testing.T) {
	...
	for _, want := range []string{
		"e2e: topology: indexing Union and Gno",
		"e2e: topology: creating underlying clients",
		"e2e: topology: creating Lens clients",
		"e2e: topology: indexing EVM",
		...
		"e2e: connection submitted; waiting for OPEN",
		"e2e: connection OPEN: dev.ibc/connection-1/client-2 <-> 17000/connection-1/client-2",
		"e2e: channel submitted; waiting for OPEN",
