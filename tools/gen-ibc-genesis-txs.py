...
def main() -> None:
    ...
    explicit_exclude = set(args.exclude)
    emit = {pkg for pkg in all_packages if pkg not in genesis_pkgs and pkg not in explicit_exclude and has_source_files(all_packages[pkg])}
